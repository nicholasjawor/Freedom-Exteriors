export default async function handler(req, res) {
  ...
  if (action === "auth") {
    const params = new URLSearchParams({ client_id: process.env.QB_CLIENT_ID, response_type: "code", scope: "com.intuit.quickbooks.accounting", redirect_uri: "https://freedom-exteriors.vercel.app/quickbooks/callback", state: "freedom-exteriors" });
